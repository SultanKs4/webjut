...
$('#movie-list').on('click', '#btn-details', (e) => {
                    ...
                    $('#movie-list').append(`<div class = "col-md-4 mb-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary" id="btn-details" data-id="` + data.imdbID + `"data-toggle="modal" data-target="#exampleModal">Show Details</a>
                            </div>
                        </div>
                    `);
                })
